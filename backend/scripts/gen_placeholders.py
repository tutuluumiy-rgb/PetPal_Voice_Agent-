...
输出目录：frontend/audio/placeholders/*.wav（24kHz mono 16bit PCM）
...
# 输出目录：<仓库根>/frontend/audio/placeholders（脚本在 backend/scripts/，往上 3 层到仓库根）
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
FRONTEND_AUDIO_DIR = os.path.join(_REPO_ROOT, "frontend", "audio", "placeholders")
